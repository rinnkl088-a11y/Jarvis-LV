"""
core/history.py — episodic conversation log (PHASE 1, additive).

Appends {ts, role, text} to memory/history.jsonl (bounded, gitignored).
Lets the agent answer "what did we do yesterday" without loading
everything. Stdlib only, thread-safe, capped for 8GB RAM.
"""
