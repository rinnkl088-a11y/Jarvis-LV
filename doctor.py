"""
JARVIS-X doctor — diagnose environment without exposing secrets.

Run:  python doctor.py
Checks: Python, deps, mic/audio, API config, permissions,
screen capture, Phase-1 infra imports. Exit 0 = usable.
"""
...
def main() -> int:
    print("JARVIS-X doctor —", platform.system(), platform.release())
    ok_all = True
